...
const dict = {
  "zh-CN": {
    ...
    releaseHighlights: "本次更新",
    releaseBlueprint: "BluePrint：原生瀑布流卡片、Markdown 原位编辑与更安全的保存重放。",
    releaseCalendar: "快捷日历：离线农历、2026 节假日与补班，以及全年调休表。",
    releaseCatalog: "21 个安装包、版本记录与 SHA-256 校验信息已同步刷新。",
    statPlugins: "插件",
    statUpdated: "最近更新",
    statSource: "目录源",
  ...
  en: {
    ...
    releaseHighlights: "Latest update",
    releaseBlueprint: "BluePrint: native masonry cards, Markdown inline editing, and replay-safe saves.",
    releaseCalendar: "Calendar: offline lunar dates, 2026 holidays and make-up workdays, plus the annual schedule.",
    releaseCatalog: "All 21 packages, release histories, and SHA-256 metadata are refreshed.",
    statPlugins: "Plugins",
