const TEXT = {
  en: {
    ...
    noDisplaysHint: "Built-in panels use the OS brightness service (DisplayServices on macOS, WMI on Windows). External monitors use Qx's embedded DDC/CI transport when the monitor and connection expose it.",
  ...
  zh: {
    ...
    noDisplaysHint: "内置屏幕使用系统亮度服务（macOS DisplayServices / Windows WMI）；外接显示器在硬件和连接支持时使用 Qx 内置的 DDC/CI 通道，无需安装外部命令行工具。",
    setting: "正在设置亮度…",
