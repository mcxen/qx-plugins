...
function Grid(props) {
  ...
  const columns = Number(props.columns) > 0 ? Number(props.columns) : void 0;
  const children = filterChildrenBySearch(props.children, props.onSearchTextChange ? "" : query);
  return import_react.default.createElement(
    "div",
    { className: "qx-raycast-view" },
...
var import_react, defaultPreferenceValues, Color, Toast, Clipboard;
var init_api = __esm({
  "qx-virtual:@raycast/api"() {
    import_react = __toESM(require_react());
    defaultPreferenceValues = { "weekStart": "1", "showWeeks": true, "viewMode": "1" };
    Color = {
      Blue: "blue",
      Green: "green",
      Orange: "orange",
...
// ../../../../../private/var/folders/ng/zj6dzdcj0vx8chjb0yp1t4740000gn/T/qx-raycast-url-usjRHD/repo/extensions/calendar/node_modules/calendar/lib/calendar.js
var require_calendar = __commonJS({
  "../../../../../private/var/folders/ng/zj6dzdcj0vx8chjb0yp1t4740000gn/T/qx-raycast-url-usjRHD/repo/extensions/calendar/node_modules/calendar/lib/calendar.js"(exports) {
    ...
    var Calendar2 = function Calendar3(firstWeekDay) {
    ...
    Calendar2.prototype = {
      ...
      monthDates: function monthDates(year, month, dayFormatter, weekFormatter) {
        ...
        ;
        var weeks = [], week = [], i2 = 0, date = this.weekStartDate(new Date(year, month, 1));
        do {
          for (i2 = 0; i2 < 7; i2++) {
      ...
      monthDays: function monthDays(year, month) {
        var getDayOrZero = function getDayOrZero2(date) {
      ...
      monthText: function monthText(year, month) {
        ...
        ;
        var getDayOrBlank = function getDayOrBlank2(date) {
    ...
    for (i = 0; i < months.length; i++)
      Calendar2[months[i]] = i;
    var i;
    exports.Calendar = Calendar2;
  }
});

// ../../../../../private/var/folders/ng/zj6dzdcj0vx8chjb0yp1t4740000gn/T/qx-raycast-url-usjRHD/repo/extensions/calendar/node_modules/weeknumber/src/index.js
...
var init_src = __esm({
  "../../../../../private/var/folders/ng/zj6dzdcj0vx8chjb0yp1t4740000gn/T/qx-raycast-url-usjRHD/repo/extensions/calendar/node_modules/weeknumber/src/index.js"() {
    ...
    weekNumber = (date = /* @__PURE__ */ new Date()) => {
      const day = (date.getDay() + 6) % 7;
      const thursday = new Date(date);
      thursday.setDate(date.getDate() - day + 3);
      const firstThursday = new Date(thursday.getFullYear(), 0, 1);
      if (firstThursday.getDay() !== 4) {
        firstThursday.setMonth(0, 1 + (11 - firstThursday.getDay()) % 7);
      }
      const weekNumber2 = 1 + Math.floor((thursday - firstThursday + tzDiff(firstThursday, thursday)) / WEEK);
      return weekNumber2;
    };
    weekNumberSun = (date = /* @__PURE__ */ new Date()) => {
      ...
      const weekNumber2 = 1 + Math.floor((sunday - firstSunday + tzDiff(firstSunday, sunday)) / WEEK);
      return weekNumber2;
    };
  }
});
...
// raycast-source/calendar/src/index.tsx
var src_exports = {};
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    Detail,
    {
      ...
      actions: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ActionPanel, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(ActionPanel.Section, { title: header, children: [
...
var init_src2 = __esm({
  "../../../../../private/var/folders/ng/zj6dzdcj0vx8chjb0yp1t4740000gn/T/qx-raycast-url-usjRHD/repo/extensions/calendar/src/index.tsx"() {
    "use strict";
    init_api();
    import_react2 = __toESM(require_react());
    import_calendar = __toESM(require_calendar());
    init_src();
    ...
    weekStart = Number(getPreferenceValues().weekStart);
    showWeeks = getPreferenceValues().showWeeks;
    viewMode = getPreferenceValues().viewMode;
...
function renderElement(container, element) {
  ...
  root.render(element || import_react3.default.createElement("div", { className: "qx-raycast-empty" }, "No view"));
}
async function hydrateFilesystem(context, preferences2) {
  const dirs = /* @__PURE__ */ new Set([
    "/qx-plugin-files/raycast-calendar",
    "/qx-home/Downloads"
  ]);
  const downloadDirectory = String(preferences2?.downloadDirectory || "");
...
async function invokeCommand(name, container, context, options = {}) {
  ...
  globalThis.__qxRaycastRuntime = {
    ...
    cache,
    launchType,
    supportPath: "/qx-plugin-files/raycast-calendar",
    assetsPath: "",
  ...
  if (mode === "view") {
    const element = import_react3.default.isValidElement(component) ? component : import_react3.default.createElement(component);
    renderElement(container, element);
    return;
  }
  const result = typeof component === "function" ? await component({}) : component;
  if (import_react3.default.isValidElement(result)) {
    renderElement(container, result);
  } else if (container) {
    renderElement(container, import_react3.default.createElement("div", { className: "qx-raycast-empty" }, result == null ? "" : String(result)));
  }
}
var entry_default = {
